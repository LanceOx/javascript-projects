...
function askForNumber() {
  ...
  while (numMeals > 6){           //this while loop should prompt them until the correct answer is given//
  numMeals = input.questionInt("Invalid amount. Please choose another number 1 - 6. ");
